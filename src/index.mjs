...
import { transcripcionOCRImagen, loadAndConvertPdf, asegurarParPDFPNG, convertirPNGABase64, obtenerArchivosPDFCrawler, obtenerArchivosPDF } from './pdfUtils.mjs';
...
const ejecucion_seleccionada = solo_transcripcion;
...
//     // Calcular el costo
//     logger.info(`Tokens para ${nombre}: Tokens input: ${tokensI}, Tokens output: ${tokensO}, Tokens totales: ${tokensI + tokensO}`);

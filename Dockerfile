...
# gcloud run deploy backend --image gcr.io/cosas-formantia/backend:latest --platform managed --region europe-southwest1 --allow-unauthenticated --memory 4Gi --cpu 2 --timeout 30m --max-instances 5 --min-instances 0 --concurrency 80
